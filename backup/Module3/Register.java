...
//    boolean status= wait.until(ExpectedConditions.urlToBe("https://crio-qkart-frontend-qa.vercel.app/login")) ;
       try {
        WebDriverWait wait = new WebDriverWait(driver, 10);
        status= wait.until(ExpectedConditions.urlToBe("https://crio-qkart-frontend-qa.vercel.app/login")) ;
